...
export default function NeetPage() {
  ...
  }, [subject, bookmarkedOnly, bookmarks]);
  ...
  function selectAnswer(option: string) {
    ...
    if (!selectedAnswer) {
      recordAnswer(APP_ID, currentQuestion.subject, option === currentQuestion.answer);
    }
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-slate-100">
      <div className="mx-auto max-w-7xl">
        ...
        <ProgressPanel stats={stats} currentLabel={subject} />
        ...
        {mode === "test" ? (
          ...
          <section className="rounded-3xl border border-red-400/40 bg-red-400/10 p-6">
            <p className="text-red-200">
              No questions found. Try a different subject or turn off the bookmarked filter.
            </p>
          </section>
        ) : (
